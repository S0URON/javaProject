...
//	output		[3, plante_test3, 30.0, 250, Arbustes Fleuris, Pauvre, Persistant, Mi-ombre]
				...
				Plante newPlant = new Plante(Integer.parseInt(element.get(0)),element.get(1), element.get(4), element.get(5), element.get(6), element.get(7), Float.parseFloat(element.get(2)), Integer.parseInt(element.get(3)));
				liste.add(newPlant);
			}
